# Experience index
# Format: keywords | episode_file | outcome | confidence
...
2. Load matching episodes (max 3 most relevant)
3. Extract: approach_used, what_worked, what_failed, outcome
4. Adapt approach to current context